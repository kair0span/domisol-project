...
export const ScoreSchema = z
  .object({
    ...
    descriptionDe: z.string().min(1, "Description DE is required").max(10000),
    descriptionFr: z.string().min(1, "Description FR is required").max(10000),
    descriptionEn: z.string().min(1, "Description EN is required").max(10000),
